...
$(document).ready(function() {
  ...
  $("form#new-contact").submit(function(event) {
    ...
    const inputtedPhoneNumber = []
    inputtedPhoneNumber.push($("input#new-phone-number").val());
    inputtedPhoneNumber.push($("input#new-additional-phone-number").val());
    ...
    $("input#new-additional-phone-number").val("");
